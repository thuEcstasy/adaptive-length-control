...
# MATH_QUERY_TEMPLATE = """Solve the problem: {Question}"""
...
# MATH_QUERY_TEMPLATE = """Return your final response within \\boxed{{}}. {Question}"""
...
mix_gold_metric = multilingual_extractive_match_metric(
    language=Language.ENGLISH, 
    fallback_mode="first_match", 
    precision=5, 
...
minervamath = LightevalTaskConfig(
    ...
    # hf_repo="haoyuw/minerva",
    hf_repo="haoyuw/minervamath_latex",
    hf_subset="default",
    hf_avail_splits=["test"],
    evaluation_splits=["test"],
    few_shots_split=None,
